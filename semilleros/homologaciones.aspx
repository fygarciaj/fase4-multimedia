<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/home.Master" CodeBehind="homologaciones.aspx.vb" Inherits="semilleros.Formulario_web12" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <!-- Logo -->
        <img src="images/unadlogo.png" alt="Logo" width="750" height="150" />
        <h1>HOMOLOGACIONES</h1>
        <img src="images/validacion.jpg" alt="Logo" width="650" height="150" />
        ...
        <embed src="docs/homologacion.pdf" type="application/pdf" width="600" height="500" />

        <div class="section-title">Escucha el siguiente audio informativo:</div>
        <audio controls>
            <source src="sonido/audiohomologaciones.mp3" type="audio/mpeg" />
